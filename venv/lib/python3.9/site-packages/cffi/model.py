        ...
        if self.abi == "__stdcall":
            if not self.ellipsis:  # __stdcall ignored for variadic funcs
                try:
                    ...
                    pass
        return global_cache(self, ffi, 'new_function_type', tuple(args),
                            result, self.ellipsis, *abi_args)
...
class StructOrUnion(StructOrUnionOrEnum):
    ...
    def finish_backend_type(self, ffi, finishlist):
        ...
        if self.fldtypes is None:
            ...
            ffi._backend.complete_struct_or_union(BType, lst, self, -1, -1,
                                                  *extra_flags)
            #
        else:
            fldtypes = []
            ...
            ffi._backend.complete_struct_or_union(BType, lst, self, totalsize,
                                                  totalalignment)
        self.completed = 2
    ...
    def build_backend_type(self, ffi, finishlist):
        ...
        #
        return global_cache(self,
                            ffi,
                            'new_%s_type' % self.kind,
