...
class Verifier(object):
    def __init__(self,
        ...
        if modulename:
            ...
            key = '\x00'.join([
                '%d.%d' % sys.version_info[:2], __version_verifier_modules__,
        ...
        self.sourcefilename = os.path.join(self.tmpdir,
                                           modulename + source_extension)
...
def cleanup_tmpdir(tmpdir=None, keep_so=False):
    ...
    for fn in filelist:
        if fn.lower().startswith('_cffi_') and (fn.lower().endswith(suffix)
                                                or fn.lower().endswith('.c')):
            try:
