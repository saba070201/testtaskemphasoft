...
def is_unicode_range_secondary(range_name: str) -> bool:
    return any(keyword in range_name
...
def any_specified_encoding(sequence: bytes,
                           search_zone: int = 8192) -> Optional[str]:
    """
...
def is_multi_byte_encoding(name: str) -> bool:
    ...
    return name in {
        ...
        importlib.import_module(
            "encodings.{}".format(name)).IncrementalDecoder,
...
def cp_similarity(iana_name_a: str, iana_name_b: str) -> float:
    ...
    decoder_a = importlib.import_module(
        "encodings.{}".format(iana_name_a)).IncrementalDecoder
    decoder_b = importlib.import_module(
        "encodings.{}".format(iana_name_b)).IncrementalDecoder
...
def is_cp_similar(iana_name_a: str, iana_name_b: str) -> bool:
    ...
    """
    return (iana_name_a in IANA_SUPPORTED_SIMILAR
    ...
    if decoded_payload and is_multi_byte_decoder is False:
        ...
        for i in offsets:
            ...
            if is_multi_byte_decoder and i > 0:
                ...
                if (decoded_payload and chunk[:chunk_partial_size_chk]
                        not in decoded_payload):
