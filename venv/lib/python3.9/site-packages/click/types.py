...
class _NumberRangeBase(_NumberParamTypeBase):
    ...
    def convert(self, value: t.Any, param: t.Optional["Parameter"],
        ...
        lt_min: bool = self.min is not None and (
            operator.le if self.min_open else operator.lt)(rv, self.min)
        gt_max: bool = self.max is not None and (
            operator.ge if self.max_open else operator.gt)(rv, self.max)
    ...
    def _clamp(self, bound: float, dir: "te.Literal[1, -1]",
               open: bool) -> float:
...
class BoolParamType(ParamType):
    ...
    def convert(self, value: t.Any, param: t.Optional["Parameter"],
        ...
        self.fail(
            _("{value!r} is not a valid boolean.").format(value=value), param,
            ctx)
...
class UUIDParameterType(ParamType):
    ...
    def convert(self, value: t.Any, param: t.Optional["Parameter"],
        ...
        try:
            ...
            self.fail(
                _("{value!r} is not a valid UUID.").format(value=value), param,
                ctx)
...
class File(ParamType):
    ...
    def resolve_lazy_flag(self,
                          value: "t.Union[str, os.PathLike[str]]") -> bool:
    ...
    def convert(
        ...
        try:
            ...
            f, should_close = open_stream(value,
                                          self.mode,
                                          self.encoding,
                                          self.errors,
                                          atomic=self.atomic)
...
class Tuple(CompositeParamType):
    ...
    """
    def __init__(self, types: t.Sequence[t.Union[t.Type[t.Any],
                                                 ParamType]]) -> None:
