...
def open_resource(name):
    ...
    if zoneinfo_dir is not None:
        ...
        filename = os.path.join(os.path.dirname(__file__), 'zoneinfo',
                                *name_parts)
...
def _case_insensitive_zone_lookup(zone):
    ...
    if _all_timezones_lower_to_standard is None:
        _all_timezones_lower_to_standard = dict(
            (tz.lower(), tz) for tz in _all_timezones_unchecked)  # noqa
...
['Africa/Abidjan',
   ...
   'WET',
   'Zulu']
all_timezones = LazyList(tz for tz in _all_timezones_unchecked
                         if resource_exists(tz))
