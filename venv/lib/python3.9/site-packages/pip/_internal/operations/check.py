...
def check_package_set(
        ...
        should_ignore: Optional[Callable[[str], bool]] = None) -> CheckResult:
...
def check_install_conflicts(
    ...
    return (
        ...
        check_package_set(package_set,
                          should_ignore=lambda name: name not in whitelist),
    )
...
def _create_whitelist(would_be_installed: Set[NormalizedName],
                      package_set: PackageSet) -> Set[NormalizedName]:
