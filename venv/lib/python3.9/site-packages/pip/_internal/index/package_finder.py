...
CandidateSortingKey = Tuple[int, int, int, _BaseVersion, Optional[int],
                            BuildTag]
...
class CandidateEvaluator:
    ...
    def __init__(
        ...
        self._wheel_tag_preferences = {
            tag: idx
            for idx, tag in enumerate(supported_tags)
        }
...
class PackageFinder:
    ...
    def evaluate_links(self, link_evaluator: LinkEvaluator,
                       links: Iterable[Link]) -> List[InstallationCandidate]:
        """
...
def _extract_version_from_fragment(fragment: str,
