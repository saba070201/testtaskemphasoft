...
class Git(VersionControl):
    ...
    @classmethod
    def get_revision_sha(cls, dest: str,
                         rev: str) -> Tuple[Optional[str], bool]:
        """
    ...
    def fetch_new(self, dest: str, url: HiddenText, rev_options: RevOptions,
        ...
        if rev_options.rev:
            ...
            logger.debug("Rev options %s, branch_name %s", rev_options,
                         branch_name)
    ...
    def get_url_rev_and_auth(cls,
        ...
        if scheme.endswith("file"):
            ...
            newpath = initial_slashes + urllib.request.url2pathname(
                path).replace("\\", "/").lstrip("/")
