...
class NetworkConnectionError(PipError):
    ...
    def __init__(self,
        ...
        if (self.response is not None and not self.request
...
class MetadataInconsistent(InstallationError):
    ...
    def __str__(self) -> str:
        template = ("Requested {} has inconsistent {}: "
    ...
    def __init__(
        ...
        *,
        ...
        if output_lines is None:
            ...
            output_prompt = (Text.from_markup(
...
class HashMissing(HashError):
    ...
    def body(self) -> str:
        ...
        if self.req:
            ...
            package = (
                self.req.original_link if self.req.original_link
                # In case someone feeds something downright stupid
                # to InstallRequirement's constructor.
                else getattr(self.req, "req", None))
        return "    {} --hash={}:{}".format(package or "unknown package",
                                            FAVORITE_HASH, self.gotten_hash)
