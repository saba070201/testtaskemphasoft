...
class PipProvider(_ProviderBase):
    ...
    def identify(
            self, requirement_or_candidate: Union[Requirement,
                                                  Candidate]) -> str:
    ...
    def get_preference(  # type: ignore
        ...
        * If equal, order alphabetically for consistency (helps debuggability).
        ...
        try:
            ...
            parent_depths = (self._known_depths[parent.name]
    ...
    def get_dependencies(self, candidate: Candidate) -> Sequence[Requirement]:
        ...
        return [
            r for r in candidate.iter_dependencies(with_requires)
            if r is not None
        ]
    ...
    def is_backtrack_cause(
            identifier: str,
            backtrack_causes: Sequence["PreferenceInformation"]) -> bool:
