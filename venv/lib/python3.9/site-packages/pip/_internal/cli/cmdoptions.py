...
def check_install_build_global(options: Values,
                               check_options: Optional[Values] = None) -> None:
...
def check_dist_restriction(options: Values,
...
debug_mode: Callable[..., Option] = partial(
    ...
    action="store_true",
    default=False,
    help=("Let unhandled exceptions propagate outside the main subroutine, "
...
require_virtualenv: Callable[..., Option] = partial(
    ...
    action="store_true",
    default=False,
    help=("Allow pip to only run in a virtual environment; "
...
def _handle_no_binary(option: Option, opt_str: str, value: str,
                      parser: OptionParser) -> None:
...
def _handle_only_binary(option: Option, opt_str: str, value: str,
                        parser: OptionParser) -> None:
    existing = _get_format_control(parser.values, option)
    FormatControl.handle_mutual_excludes(
        value,
