...
class InstallCommand(RequirementCommand):
    ...
    def _handle_target_dir(self, target_dir: str,
    ...
    def _determine_conflicts(
            self,
            to_install: List[InstallRequirement]) -> Optional[ConflictDetails]:
        try:
    ...
    def _warn_about_conflicts(self, conflict_details: ConflictDetails,
                              resolver_variant: str) -> None:
            ...
            for dep_name, dep_version, req in conflicting[project_name]:
                message = (
                    ...
                    "{dep_name} {dep_version} which is incompatible.").format(
                        ...
                        you=("you" if resolver_variant == "2020-resolver" else
                             "you'll"),
                    )
                parts.append(message)
...
def create_os_error_message(error: OSError, show_traceback: bool,
                            using_user_site: bool) -> str:
    ...
    # more than 260
    if (WINDOWS and error.errno == errno.ENOENT and error.filename
            and len(error.filename) > 260):
        parts.append("HINT: This error might have occurred since "
