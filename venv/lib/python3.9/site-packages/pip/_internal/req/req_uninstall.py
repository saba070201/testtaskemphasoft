...
def _script_names(bin_dir: str, script_name: str,
                  is_gui: bool) -> Iterator[str]:
...
class UninstallPathSet:
    ...
    def from_dist(cls, dist: BaseDistribution) -> "UninstallPathSet":
        ...
        setuptools_flat_installation = (
            ...
            and info_location is not None and os.path.exists(info_location)
        ...
        try:
            for script in dist.iterdir("scripts"):
                ...
                if WINDOWS:
                    paths_to_remove.add(
                        os.path.join(bin_dir, f"{script.name}.bat"))
...
class UninstallPthEntries:
    ...
    def remove(self) -> None:
        ...
        if not os.path.isfile(self.file):
            logger.warning("Cannot remove entries from nonexistent file %s",
                           self.file)
            return
