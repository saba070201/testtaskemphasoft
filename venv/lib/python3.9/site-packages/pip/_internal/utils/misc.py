...
def rmtree_errorhandler(func: Callable[..., Any], path: str,
...
def read_chunks(file: BinaryIO,
                size: int = io.DEFAULT_BUFFER_SIZE) -> Iterator[bytes]:
...
def _transform_url(
    url: str,
    transform_netloc: Callable[[str], Tuple[Any,
