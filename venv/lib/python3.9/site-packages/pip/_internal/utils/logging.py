...
def _is_broken_pipe_error(exc_class: Type[BaseException],
    ...
    return isinstance(exc,
                      OSError) and exc.errno in (errno.EINVAL, errno.EPIPE)
...
class RichPipStreamHandler(RichHandler):
    ...
    def emit(self, record: logging.LogRecord) -> None:
        ...
        if record.msg == "[present-diagnostic] %s" and len(record.args) == 1:
            diagnostic_error: DiagnosticPipError = record.args[
                0]  # type: ignore[index]
    ...
    def handleError(self, record: logging.LogRecord) -> None:
        ...
        if (exc_class and exc and self.console.file is sys.stdout
