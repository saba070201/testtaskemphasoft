...
try:
    ...
    class cached_property(object):  # type: ignore
        ...
        def __get__(self, obj, owner):
            ...
            assert obj is not None, "call {} on an instance".format(
                self._fname)
...
class LinuxDistribution(object):
    ...
    def __init__(
        ...
        * :py:exc:`UnicodeError`: A data source has unexpected characters or
        ...
        self.etc_dir = os.path.join(root_dir,
                                    "etc") if root_dir else _UNIXCONFDIR
        ...
        if os_release_file:
            ...
            etc_dir_os_release_file = os.path.join(self.etc_dir,
                                                   _OS_RELEASE_BASENAME)
            usr_lib_os_release_file = os.path.join(self.usr_lib_dir,
                                                   _OS_RELEASE_BASENAME)
    ...
    def name(self, pretty=False):
        ...
        name = (self.os_release_attr("name")
                ...
                or self.distro_release_attr("name") or self.uname_attr("name"))
        if pretty:
    ...
    def codename(self):
        ...
        try:
            ...
            return (self.lsb_release_attr("codename")
                    or self.distro_release_attr("codename") or "")
    ...
    def _distro_release_info(self):
        ...
        if self.distro_release_file:
            ...
            if "name" in distro_info and "cloudlinux" in distro_info[
                    "name"].lower():
...
def main():
    ...
    if args.root_dir:
        dist = LinuxDistribution(include_lsb=False,
                                 include_uname=False,
