...
FORMATTERS = {
    'BBCodeFormatter':
    ('pygments.formatters.bbcode', 'BBCode', ('bbcode', 'bb'), (),
    ...
    'SvgFormatter':
    ('pygments.formatters.svg', 'SVG', ('svg', ), ('*.svg', ),
    ...
    ('pygments.formatters.terminal256', 'Terminal256',
    ...
    'TerminalFormatter':
    ('pygments.formatters.terminal', 'Terminal', ('terminal', 'console'), (),
    ...
    ('pygments.formatters.terminal256', 'TerminalTrueColor',
    ...
    'TestcaseFormatter': ('pygments.formatters.other', 'Testcase',
                          ('testcase', ), (),
    ...
    for root, dirs, files in os.walk('.'):
        for filename in files:
            if filename.endswith('.py') and not filename.startswith('_'):
                module_name = 'pygments.formatters%s.%s' % (root[1:].replace(
                    '/', '.'), filename[:-3])
                print(module_name)
                ...
                for formatter_name in module.__all__:
                    ...
                    found_formatters.append(
                        '%r: %r' %
                        (formatter_name,
                         (module_name, formatter.name, tuple(
                             formatter.aliases), tuple(formatter.filenames),
