...
class FontManager:
    ...
    def _create_mac(self):
        ...
        for style in ('ITALIC', 'BOLD', 'BOLDITALIC'):
            for stylename in STYLES[style]:
                path = self._get_mac_font_path(font_map, self.font_name,
                                               stylename)
                if path is not None:
                    self.fonts[style] = ImageFont.truetype(
                        path, self.font_size)
    ...
    def _create_win(self):
        lookuperror = None
        keynames = [(_winreg.HKEY_CURRENT_USER,
        ...
        for keyname in keynames:
            try:
                ...
                try:
                    path = self._lookup_win(key, self.font_name,
                                            STYLES['NORMAL'], True)
...
class ImageFormatter(Formatter):
    ...
    def format(self, tokensource, outfile):
        ...
        im = Image.new(
            'RGB', self._get_image_size(self.maxlinelength, self.maxlineno),
