...
class _CipherContext:
    ...
    def __init__(self, backend: Backend, cipher, mode, operation: int) -> None:
        ...
        if res == 0 and (
            (not lib.CRYPTOGRAPHY_IS_LIBRESSL and errors[0]._lib_reason_match(
                lib.ERR_LIB_EVP, lib.EVP_R_XTS_DUPLICATED_KEYS)) or
            (lib.Cryptography_HAS_PROVIDERS and errors[0]._lib_reason_match(
    ...
    def update_into(self, data: bytes, buf: bytes) -> int:
        ...
        while data_processed != total_data_len:
            ...
            res = self._backend._lib.EVP_CipherUpdate(self._ctx, outbuf,
                                                      outlen, inbuf, inlen)
    ...
    def finalize(self) -> bytes:
        ...
        if res == 0:
            ...
            self._backend.openssl_assert(
                ...
                ) or (lib.Cryptography_HAS_PROVIDERS
                      and errors[0]._lib_reason_match(
                          lib.ERR_LIB_PROV,
                          lib.PROV_R_WRONG_FINAL_BLOCK_LENGTH,
                      ))
                or (lib.CRYPTOGRAPHY_IS_BORINGSSL and errors[0].reason
