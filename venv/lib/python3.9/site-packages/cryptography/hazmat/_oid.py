...
_OID_NAMES = {
    ...
    "ctPoison",
    ExtensionOID.MS_CERTIFICATE_TEMPLATE:
    ...
    "caRepository",
    CertificatePoliciesOID.CPS_QUALIFIER:
    "id-qt-cps",
    CertificatePoliciesOID.CPS_USER_NOTICE:
    "id-qt-unotice",
    OCSPExtensionOID.NONCE:
    "OCSPNonce",
