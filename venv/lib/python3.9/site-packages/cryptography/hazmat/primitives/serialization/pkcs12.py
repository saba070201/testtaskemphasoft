...
PKCS12PrivateKeyTypes = typing.Union[rsa.RSAPrivateKey, dsa.DSAPrivateKey,
...
class PKCS12KeyAndCertificates:
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return (self.key == other.key and self.cert == other.cert
...
) -> typing.Tuple[typing.Optional[PrivateKeyTypes], typing.
                  Optional[x509.Certificate], typing.List[x509.Certificate], ]:
