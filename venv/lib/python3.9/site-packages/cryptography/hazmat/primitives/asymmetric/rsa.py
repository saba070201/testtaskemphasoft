...
def rsa_recover_prime_factors(n: int, e: int,
                              d: int) -> typing.Tuple[int, int]:
    """
...
class RSAPrivateNumbers:
    def __init__(
        ...
        if (not isinstance(p, int) or not isinstance(q, int)
                or not isinstance(d, int) or not isinstance(dmp1, int)
                or not isinstance(dmq1, int) or not isinstance(iqmp, int)):
            raise TypeError(
