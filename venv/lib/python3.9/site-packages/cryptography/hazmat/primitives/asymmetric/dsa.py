...
class DSAParameterNumbers:
    ...
    def __repr__(self) -> str:
        return ("<DSAParameterNumbers(p={self.p}, q={self.q}, "
...
class DSAPublicNumbers:
    ...
    def __repr__(self) -> str:
        return ("<DSAPublicNumbers(y={self.y}, "
                "parameter_numbers={self.parameter_numbers})>".format(
                    self=self))
...
def generate_parameters(key_size: int,
                        backend: typing.Any = None) -> DSAParameters:
    from cryptography.hazmat.backends.openssl.backend import backend as ossl

    return ossl.generate_dsa_parameters(key_size)


def generate_private_key(key_size: int,
                         backend: typing.Any = None) -> DSAPrivateKey:
    from cryptography.hazmat.backends.openssl.backend import backend as ossl
