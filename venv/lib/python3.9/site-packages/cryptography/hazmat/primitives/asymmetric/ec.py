...
class EllipticCurveSignatureAlgorithm(metaclass=abc.ABCMeta):
    ...
    @abc.abstractmethod
    def algorithm(
        self, ) -> typing.Union[asym_utils.Prehashed, hashes.HashAlgorithm]:
        """
...
class EllipticCurvePrivateKey(metaclass=abc.ABCMeta):
    @abc.abstractmethod
    def exchange(self, algorithm: ECDH,
...
class EllipticCurvePublicKey(metaclass=abc.ABCMeta):
    ...
    @classmethod
    def from_encoded_point(cls, curve: EllipticCurve,
                           data: bytes) -> EllipticCurvePublicKey:
...
def generate_private_key(
        curve: EllipticCurve,
        backend: typing.Any = None) -> EllipticCurvePrivateKey:
...
class EllipticCurvePublicNumbers:
    ...
    def __repr__(self) -> str:
        return ("<EllipticCurvePublicNumbers(curve={0.curve.name}, x={0.x}, "
                "y={0.y}>".format(self))
