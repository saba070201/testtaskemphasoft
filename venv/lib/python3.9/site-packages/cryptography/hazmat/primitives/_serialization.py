...
class KeySerializationEncryptionBuilder:
    ...
    def hmac_hash(
            self,
            algorithm: HashAlgorithm) -> KeySerializationEncryptionBuilder:
    ...
    def key_cert_algorithm(
            self, algorithm: PBES) -> KeySerializationEncryptionBuilder:
        if self._format is not PrivateFormat.PKCS12:
            raise TypeError("key_cert_algorithm only supported with "
