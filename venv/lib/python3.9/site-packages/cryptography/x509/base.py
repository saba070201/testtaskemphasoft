...
# identify_hash_type
_AllowedHashTypes = typing.Union[hashes.SHA224, hashes.SHA256, hashes.SHA384,
                                 hashes.SHA512, hashes.SHA3_224,
                                 hashes.SHA3_256, hashes.SHA3_384,
                                 hashes.SHA3_512, ]
...
class Certificate(metaclass=abc.ABCMeta):
    ...
    def signature_hash_algorithm(
        self, ) -> typing.Optional[hashes.HashAlgorithm]:
        """
    ...
    def signature_algorithm_parameters(
        self, ) -> typing.Union[None, padding.PSS, padding.PKCS1v15, ec.ECDSA]:
        """
...
class CertificateRevocationList(metaclass=abc.ABCMeta):
    ...
    def get_revoked_certificate_by_serial_number(
            self, serial_number: int) -> typing.Optional[RevokedCertificate]:
        """
    ...
    def is_signature_valid(
            self, public_key: CertificateIssuerPublicKeyTypes) -> bool:
        """
...
def load_pem_x509_certificate(data: bytes,
                              backend: typing.Any = None) -> Certificate:
...
def load_pem_x509_csr(data: bytes,
                      backend: typing.Any = None) -> CertificateSigningRequest:
...
def load_pem_x509_crl(data: bytes,
                      backend: typing.Any = None) -> CertificateRevocationList:
...
class CertificateSigningRequestBuilder:
    ...
    def add_extension(self, extval: ExtensionType,
                      critical: bool) -> CertificateSigningRequestBuilder:
        """
...
class CertificateBuilder:
    ...
    def add_extension(self, extval: ExtensionType,
                      critical: bool) -> CertificateBuilder:
        """
    ...
    def sign(
        ...
        backend: typing.Any = None,
        *,
        rsa_padding: typing.Optional[typing.Union[padding.PSS,
                                                  padding.PKCS1v15]] = None,
    ) -> Certificate:
        """
...
class CertificateRevocationListBuilder:
    ...
    def issuer_name(self,
                    issuer_name: Name) -> CertificateRevocationListBuilder:
    ...
    def add_extension(self, extval: ExtensionType,
                      critical: bool) -> CertificateRevocationListBuilder:
        """
...
class RevokedCertificateBuilder:
    ...
    def revocation_date(self,
                        time: datetime.datetime) -> RevokedCertificateBuilder:
        if not isinstance(time, datetime.datetime):
            raise TypeError("Expecting datetime object.")
        ...
        if time < _EARLIEST_UTC_TIME:
            raise ValueError("The revocation date must be on or after"
                             " 1950 January 1.")
        return RevokedCertificateBuilder(self._serial_number, time,
                                         self._extensions)

    def add_extension(self, extval: ExtensionType,
                      critical: bool) -> RevokedCertificateBuilder:
        if not isinstance(extval, ExtensionType):
            raise TypeError("extension must be an ExtensionType")
