...
class _SingleResponse:
    def __init__(
        ...
        if next_update is not None and not isinstance(next_update,
                                                      datetime.datetime):
...
class OCSPRequestBuilder:
    def __init__(
        self,
        request: typing.Optional[typing.Tuple[x509.Certificate,
                                              x509.Certificate,
                                              hashes.HashAlgorithm]] = None,
        request_hash: typing.Optional[typing.Tuple[
            bytes, bytes, int, hashes.HashAlgorithm]] = None,
    ...
    def add_certificate(
        ...
        return OCSPRequestBuilder((cert, issuer, algorithm),
                                  self._request_hash, self._extensions)
    ...
    def add_certificate_by_hash(
        ...
        if algorithm.digest_size != len(
                issuer_name_hash) or algorithm.digest_size != len(
                    issuer_key_hash):
            raise ValueError(
    ...
    def add_extension(self, extval: x509.ExtensionType,
                      critical: bool) -> OCSPRequestBuilder:
        ...
        return OCSPRequestBuilder(self._request, self._request_hash,
...
class OCSPResponseBuilder:
    def __init__(
        ...
        responder_id: typing.Optional[typing.Tuple[
            x509.Certificate, OCSPResponderEncoding]] = None,
    ...
    def responder_id(self, encoding: OCSPResponderEncoding,
                     responder_cert: x509.Certificate) -> OCSPResponseBuilder:
    ...
    def certificates(
            self,
            certs: typing.Iterable[x509.Certificate]) -> OCSPResponseBuilder:
    ...
    def add_extension(self, extval: x509.ExtensionType,
                      critical: bool) -> OCSPResponseBuilder:
        if not isinstance(extval, x509.ExtensionType):
            raise TypeError("extension must be an ExtensionType")
    ...
    def sign(
        ...
        return ocsp.create_ocsp_response(OCSPResponseStatus.SUCCESSFUL, self,
                                         private_key, algorithm)

    @classmethod
    def build_unsuccessful(
            cls, response_status: OCSPResponseStatus) -> OCSPResponse:
