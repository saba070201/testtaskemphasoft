...
ExtensionTypeVar = typing.TypeVar("ExtensionTypeVar",
                                  bound="ExtensionType",
                                  covariant=True)


def _key_identifier_from_public_key(
    public_key: CertificatePublicKeyTypes, ) -> bytes:
...
class Extensions:
    def __init__(
            self,
            extensions: typing.Iterable[Extension[ExtensionType]]) -> None:
        self._extensions = list(extensions)

    def get_extension_for_oid(
            self, oid: ObjectIdentifier) -> Extension[ExtensionType]:
        for ext in self:
            if ext.oid == oid:
                return ext
    ...
    def get_extension_for_class(
        ...
        raise ExtensionNotFound(f"No {extclass} extension was found",
                                extclass.oid)
...
class AuthorityKeyIdentifier(ExtensionType):
    ...
    def __init__(
        ...
        if (authority_cert_issuer is None) != (authority_cert_serial_number is
                                               None):
            raise ValueError(
    ...
    def from_issuer_subject_key_identifier(
            cls, ski: SubjectKeyIdentifier) -> AuthorityKeyIdentifier:
        return cls(
    ...
    def __repr__(self) -> str:
        return ("<AuthorityKeyIdentifier(key_identifier={0.key_identifier!r}, "
    ...
    def authority_cert_issuer(
        self, ) -> typing.Optional[typing.List[GeneralName]]:
...
class SubjectKeyIdentifier(ExtensionType):
    ...
    def from_public_key(
            cls,
            public_key: CertificatePublicKeyTypes) -> SubjectKeyIdentifier:
...
class AuthorityInformationAccess(ExtensionType):
    ...
    def __init__(self,
                 descriptions: typing.Iterable[AccessDescription]) -> None:
        descriptions = list(descriptions)
        if not all(isinstance(x, AccessDescription) for x in descriptions):
            raise TypeError("Every item in the descriptions list must be an "
                            "AccessDescription")
...
class AccessDescription:
    def __init__(self, access_method: ObjectIdentifier,
                 access_location: GeneralName) -> None:
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return (self.access_method == other.access_method
...
class CRLDistributionPoints(ExtensionType):
    ...
    def __init__(
            self,
            distribution_points: typing.Iterable[DistributionPoint]) -> None:
...
class DistributionPoint:
    def __init__(
        ...
        if reasons and (not isinstance(reasons, frozenset) or
                        not all(isinstance(x, ReasonFlags) for x in reasons)):
            raise TypeError("reasons must be None or frozenset of ReasonFlags")

        if reasons and (ReasonFlags.unspecified in reasons
    ...
    def __hash__(self) -> int:
        if self.full_name is not None:
            fn: typing.Optional[typing.Tuple[GeneralName,
                                             ...]] = tuple(self.full_name)
        else:
            fn = None

        if self.crl_issuer is not None:
            crl_issuer: typing.Optional[typing.Tuple[GeneralName,
                                                     ...]] = tuple(
                                                         self.crl_issuer)
        else:
            crl_issuer = None
...
class PolicyConstraints(ExtensionType):
    ...
    def __init__(
        ...
        if inhibit_policy_mapping is None and require_explicit_policy is None:
            raise ValueError("At least one of require_explicit_policy and "
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return (self.require_explicit_policy == other.require_explicit_policy
                and self.inhibit_policy_mapping
...
class CertificatePolicies(ExtensionType):
    ...
    def __init__(self, policies: typing.Iterable[PolicyInformation]) -> None:
        ...
        if not all(isinstance(x, PolicyInformation) for x in policies):
            raise TypeError("Every item in the policies list must be a "
                            "PolicyInformation")
...
class PolicyInformation:
    def __init__(
        ...
        policy_qualifiers: typing.Optional[typing.Iterable[typing.Union[
            str, UserNotice]]],
    ) -> None:
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return (self.policy_identifier == other.policy_identifier
                and self.policy_qualifiers == other.policy_qualifiers)

    def __hash__(self) -> int:
        if self.policy_qualifiers is not None:
            pq: typing.Optional[typing.Tuple[typing.Union[str, UserNotice],
                                             ...]] = tuple(
    ...
    def policy_qualifiers(
        self, ) -> typing.Optional[typing.List[typing.Union[str, UserNotice]]]:
...
class UserNotice:
    def __init__(
        ...
        if notice_reference and not isinstance(notice_reference,
                                               NoticeReference):
            raise TypeError(
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return (self.notice_reference == other.notice_reference
...
class KeyUsage(ExtensionType):
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return (self.digital_signature == other.digital_signature
...
class NameConstraints(ExtensionType):
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return (self.excluded_subtrees == other.excluded_subtrees
    ...
    def _validate_ip_name(self, tree: typing.Iterable[GeneralName]) -> None:
        if any(
                isinstance(name, IPAddress) and not isinstance(
    ...
    def _validate_dns_name(self, tree: typing.Iterable[GeneralName]) -> None:
        if any(
                isinstance(name, DNSName) and "*" in name.value
                for name in tree):
            raise ValueError(
    ...
    def __repr__(self) -> str:
        return ("<NameConstraints(permitted_subtrees={0.permitted_subtrees}, "
    ...
    @property
    def excluded_subtrees(self, ) -> typing.Optional[typing.List[GeneralName]]:
...
class Extension(typing.Generic[ExtensionTypeVar]):
    def __init__(self, oid: ObjectIdentifier, critical: bool,
                 value: ExtensionTypeVar) -> None:
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return (self.oid == other.oid and self.critical == other.critical
...
class GeneralNames:
    def __init__(self, general_names: typing.Iterable[GeneralName]) -> None:
        ...
        if not all(isinstance(x, GeneralName) for x in general_names):
            raise TypeError("Every item in the general_names list must be an "
    ...
    def get_values_for_type(
        self,
        type: typing.Union[typing.Type[DNSName],
    ...
    def get_values_for_type(
            self,
            type: typing.Type[IPAddress]) -> typing.List[_IPAddressTypes]:
        ...

    @typing.overload
    def get_values_for_type(
            self, type: typing.Type[OtherName]) -> typing.List[OtherName]:
        ...

    def get_values_for_type(
        self,
        type: typing.Union[typing.Type[DNSName], typing.Type[DirectoryName],
                           typing.Type[IPAddress], typing.Type[OtherName],
                           typing.Type[RFC822Name], typing.Type[RegisteredID],
                           typing.Type[UniformResourceIdentifier], ],
    ) -> typing.Union[typing.List[_IPAddressTypes], typing.List[str],
                      typing.List[OtherName], typing.List[Name],
                      typing.List[ObjectIdentifier], ]:
...
class PrecertificateSignedCertificateTimestamps(ExtensionType):
    ...
    def __init__(
        self,
        signed_certificate_timestamps: typing.
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return (self._signed_certificate_timestamps ==
...
class IssuingDistributionPoint(ExtensionType):
    ...
    def __init__(
        ...
        if only_some_reasons and (not isinstance(only_some_reasons, frozenset)
                                  or not all(
                                      isinstance(x, ReasonFlags)
                                      for x in only_some_reasons)):
            raise TypeError(
                "only_some_reasons must be None or frozenset of ReasonFlags")

        if only_some_reasons and (ReasonFlags.unspecified in only_some_reasons
                                  or ReasonFlags.remove_from_crl
                                  in only_some_reasons):
            raise ValueError(
                "unspecified and remove_from_crl are not valid reasons in an "
                "IssuingDistributionPoint")

        if not (isinstance(only_contains_user_certs, bool)
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return (self.full_name == other.full_name
                and self.relative_name == other.relative_name and
                self.only_contains_user_certs == other.only_contains_user_certs
    ...
    def only_some_reasons(
        self, ) -> typing.Optional[typing.FrozenSet[ReasonFlags]]:
...
class MSCertificateTemplate(ExtensionType):
    ...
    def __init__(
        ...
        if (major_version is not None and not isinstance(major_version, int)
            ) or (minor_version is not None
                  and not isinstance(minor_version, int)):
            raise TypeError(
    ...
    def __repr__(self) -> str:
        return (f"<MSCertificateTemplate(template_id={self.template_id}, "
...
class UnrecognizedExtension(ExtensionType):
    ...
    def __repr__(self) -> str:
        return ("<UnrecognizedExtension(oid={0.oid}, "
