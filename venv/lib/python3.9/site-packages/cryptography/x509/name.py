...
class NameAttribute:
    ...
    def rfc4514_string(
            self,
            attr_name_overrides: typing.Optional[_OidNameMap] = None) -> str:
        """
        ...
        dotted string.
        """
        attr_name = (attr_name_overrides.get(self.oid)
                     if attr_name_overrides else None)
...
class RelativeDistinguishedName:
    ...
    def get_attributes_for_oid(
            self, oid: ObjectIdentifier) -> typing.List[NameAttribute]:
...
class Name:
    ...
    def __init__(
            self,
            attributes: typing.Iterable[RelativeDistinguishedName]) -> None:
        ...

    def __init__(
        self,
        attributes: typing.Iterable[typing.Union[NameAttribute,
