...
class CParser(PLYParser):
    def __init__(self,
        ...
        rules_with_opt = [
            'abstract_declarator', 'assignment_expression', 'declaration_list',
            'declaration_specifiers_no_type', 'designation', 'expression',
            'identifier_list', 'init_declarator_list',
            'id_init_declarator_list', 'initializer_list',
            'parameter_type_list', 'block_item_list', 'type_qualifier_list',
    ...
    def _add_declaration_specifier(self,
                                   declspec,
                                   newspec,
                                   kind,
                                   append=False):
    ...
    def _build_declarations(self, spec, decls, typedef_namespace=False):
        ...
        for decl in decls:
            ...
            if isinstance(
                ...
                fixed_decl = self._fix_decl_name_type(declaration,
                                                      spec['type'])
    ...
    # well
    precedence = (('left', 'LOR'), ('left', 'LAND'), ('left', 'OR'),
                  ('left', 'XOR'), ('left', 'AND'), ('left', 'EQ', 'NE'),
                  ('left', 'GT', 'GE', 'LT', 'LE'),
    ...
    def p_pragmacomp_or_statement(self, p):
        ...
        if isinstance(p[1], c_ast.Pragma) and len(p) == 3:
            p[0] = c_ast.Compound(block_items=[p[1], p[2]],
                                  coord=self._token_coord(p, 1))
        else:
            p[0] = p[1]
    ...
    def p_declaration_specifiers_2(self, p):
        ...
        """
        p[0] = self._add_declaration_specifier(p[1],
                                               p[2],
                                               'storage',
                                               append=True)
    ...
    def p_direct_xxx_declarator_4(self, p):
        ...
        dim_quals = [
            qual for sublist in listed_quals for qual in sublist
            if qual is not None
        ]
        arr = c_ast.ArrayDecl(type=None,
                              dim=p[5],
    ...
    def p_parameter_declaration_2(self, p):
        ...
        #
            ...
            decl = c_ast.Typename(name='',
                                  ...
                                  align=None,
                                  type=p[2]
                                  or c_ast.TypeDecl(None, None, None, None),
    ...
    def p_direct_abstract_declarator_3(self, p):
        ...
        p[0] = c_ast.ArrayDecl(type=c_ast.TypeDecl(None, None, None, None),
    ...
    def p_iteration_statement_4(self, p):
        ...
        p[0] = c_ast.For(c_ast.DeclList(p[3], self._token_coord(p, 1)), p[4],
                         p[6], p[8], self._token_coord(p, 1))
    ...
    def p_unary_expression_3(self, p):
        ...
        """
        p[0] = c_ast.UnaryOp(p[1], p[2] if len(p) == 3 else p[3],
                             self._token_coord(p, 1))
    ...
    def p_offsetof_member_designator(self, p):
        ...
        if len(p) == 2:
            ...
            raise NotImplementedError("Unexpected parsing state. len(p): %u" %
                                      len(p))
