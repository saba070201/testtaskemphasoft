    ...
    def pattern_to_regex(
		...
		*pattern* (:class:`str` or :class:`bytes`) is the pattern to convert
        ...
        if isinstance(pattern, str):
            ...
            raise TypeError(
                f"pattern:{pattern!r} is not a unicode or byte string.")
        ...
        if pattern.startswith('#'):
            ...
            if len(pattern_segs
                   ) == 2 and pattern_segs[0] == '**' and not pattern_segs[1]:
...
class GitIgnorePattern(GitWildMatchPattern):
    ...
    def _deprecated() -> None:
		...
		Warn about deprecation.
		"""
        warnings.warn(("GitIgnorePattern ('gitignore') is deprecated. Use "
