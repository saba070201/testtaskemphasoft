...
import re
import warnings
from typing import (Any, AnyStr, Iterable, Iterator, Match as MatchHint,
                    Optional, Pattern as PatternHint, Tuple, Union)
		...
		*files* (:class:`~collections.abc.Iterable` of :class:`str`)
        ...
        warnings.warn(
            ("{0.__module__}.{0.__qualname__}.match() is deprecated. Use "
             ...
             "similar results.").format(self.__class__),
            DeprecationWarning,
            stacklevel=2)
    ...
    def __init__(
		...
		*include* (:class:`bool` or :data:`None`) must be :data:`None`
        ...
        if isinstance(pattern, (str, bytes)):
            ...
            raise TypeError(
                "pattern:{!r} is not a string, re.Pattern, or None.".format(
                    pattern))
