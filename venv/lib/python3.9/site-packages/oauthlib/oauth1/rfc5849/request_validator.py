...
class RequestValidator:
    ...
    * @dummy_access_token
    ...
    def check_client_key(self, client_key):
        ...
        return (set(client_key) <= self.safe_characters
    ...
    def check_request_token(self, request_token):
        ...
        return (set(request_token) <= self.safe_characters
                and lower <= len(request_token) <= upper)
    ...
    def check_verifier(self, verifier):
        ...
        return (set(verifier) <= self.safe_characters
