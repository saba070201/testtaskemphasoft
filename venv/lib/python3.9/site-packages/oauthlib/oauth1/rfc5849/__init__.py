...
SIGNATURE_METHODS = (SIGNATURE_HMAC_SHA1, SIGNATURE_HMAC_SHA256,
                     SIGNATURE_HMAC_SHA512, SIGNATURE_RSA_SHA1,
                     SIGNATURE_RSA_SHA256, SIGNATURE_RSA_SHA512,
                     SIGNATURE_PLAINTEXT)
...
class Client:
    ...
    def __repr__(self):
        ...
        attrs['resource_owner_secret'] = '****' if attrs[
            'resource_owner_secret'] else None
        attribute_str = ', '.join('{}={}'.format(k, v)
    ...
    def get_oauth_signature(self, request):
        ...
        normalized_uri = signature.base_string_uri(uri,
