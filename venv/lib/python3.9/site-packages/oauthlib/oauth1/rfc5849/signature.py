...
def signature_base_string(http_method: str, base_str_uri: str,
...
def _sign_hmac(hash_algorithm_name: str, sig_base_str: str, client_secret: str,
...
def _verify_hmac(hash_algorithm_name: str,
    ...
    sig_base_str = signature_base_string(request.http_method, bs_uri,
                                         norm_params)
    signature = _sign_hmac(hash_algorithm_name, sig_base_str, client_secret,
                           resource_owner_secret)
    match = safe_string_equals(signature, request.signature)
    if not match:
        log.debug('Verify HMAC failed: signature base string: %s',
                  sig_base_str)
    return match
...
def sign_hmac_sha1_with_client(sig_base_str, client):
    return _sign_hmac('SHA-1', sig_base_str, client.client_secret,
...
def sign_hmac_sha1(base_string, client_secret, resource_owner_secret):
    ...
    return _sign_hmac('SHA-1', base_string, client_secret,
                      resource_owner_secret)
...
def sign_hmac_sha256_with_client(sig_base_str, client):
    return _sign_hmac('SHA-256', sig_base_str, client.client_secret,
                      client.resource_owner_secret)
...
def verify_hmac_sha256(request,
                       client_secret=None,
                       resource_owner_secret=None):
    return _verify_hmac('SHA-256', request, client_secret,
                        resource_owner_secret)
...
def sign_hmac_sha256(base_string, client_secret, resource_owner_secret):
    ...
    return _sign_hmac('SHA-256', base_string, client_secret,
                      resource_owner_secret)
...
def sign_hmac_sha512_with_client(sig_base_str: str, client):
    return _sign_hmac('SHA-512', sig_base_str, client.client_secret,
                      client.resource_owner_secret)
...
def verify_hmac_sha512(request,
    ...
    return _verify_hmac('SHA-512', request, client_secret,
                        resource_owner_secret)
...
def _sign_rsa(hash_algorithm_name: str, sig_base_str: str,
              rsa_private_key: str):
    """
