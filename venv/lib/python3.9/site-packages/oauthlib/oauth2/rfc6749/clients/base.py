...
class Client:
    ...
    def prepare_authorization_request(self,
        ...
        auth_url = self.prepare_request_uri(authorization_url,
    ...
    def prepare_token_request(self,
                              token_url,
        ...
        if authorization_response:
            self.parse_request_uri_response(authorization_response,
                                            state=state)
        self.redirect_url = redirect_url or self.redirect_url
    ...
    def prepare_refresh_token_request(self,
                                      token_url,
                                      refresh_token=None,
                                      body='',
                                      scope=None,
    ...
    def prepare_token_revocation_request(self,
                                         revocation_url,
                                         token,
        ...
        return prepare_token_revocation_request(
            revocation_url,
            token,
    ...
    def _populate_attributes(self, response):
        warnings.warn(
            "Please switch to the public method "
