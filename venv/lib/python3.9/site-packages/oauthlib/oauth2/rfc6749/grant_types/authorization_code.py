...
def code_challenge_method_s256(verifier, challenge):
    ...
    return base64.urlsafe_b64encode(
        hashlib.sha256(
            verifier.encode()).digest()).decode().rstrip('=') == challenge
...
class AuthorizationCodeGrant(GrantTypeBase):
    ...
    def create_authorization_code(self, request):
        ...
        log.debug('Created authorization code grant %r for request %r.', grant,
                  request)
        return grant
    ...
    def create_authorization_response(self, request, token_handler):
        ...
        self.request_validator.save_authorization_code(request.client_id,
                                                       grant, request)
        return self.prepare_authorization_response(request, grant, {}, None,
                                                   302)
