...
class OAuth1(AuthBase):
    ...
    def __init__(self,
        ...
        self.client = client_class(client_key,
                                   client_secret,
                                   resource_owner_key,
    ...
    def __call__(self, r):
        ...
        if is_form_encoded:
            ...
            r.url, headers, r.body = self.client.sign(unicode(r.url),
                                                      unicode(r.method), r.body
                                                      or "", r.headers)
            ...
            r.url, headers, _ = self.client.sign(unicode(r.url),
