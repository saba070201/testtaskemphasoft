...
def create_parser():
    ...
    group.add_argument(
        ...
        help='change case of keywords, CHOICE is one of {}'.format(', '.join(
            '"{}"'.format(x) for x in _CASE_CHOICES)))
    ...
    group.add_argument('--strip-comments',
                       dest='strip_comments',
                       action='store_true',
                       default=False,
    ...
    group.add_argument('--indent_width',
                       dest='indent_width',
                       default=2,
                       type=int,
    ...
    group.add_argument('--wrap_after',
                       dest='wrap_after',
                       default=0,
                       type=int,
                       help='Column after which lists should be wrapped')

    group.add_argument('--comma_first',
                       dest='comma_first',
                       default=False,
                       type=bool,
